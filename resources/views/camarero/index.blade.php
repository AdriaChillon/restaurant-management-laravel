        ...
        <div class="flex justify-center">
            <div class="w-full lg:w-3/4">
                ...
                <div class="mt-6 text-right">
                    <a href="{{ route('camarero.create') }}"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Crear Comanda</a>
                </div>
                <br>
